# gce.nix — GCE/host-specific NixOS config for `nixos-vm1`, the aarch64 VM in
# project dataland-peter. Everything here is tied to this cloud host: hardware
...
{ modulesPath, lib, ... }:
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/b3e4ef59-d7ba-4635-9b5c-243aa94714f4";
    fsType = "ext4";
    options = [ "discard" ];
  };
  fileSystems."/boot/efi" = {
    device = "/dev/disk/by-uuid/F104-377F";
    fsType = "vfat";
